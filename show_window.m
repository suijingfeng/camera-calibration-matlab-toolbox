function show_window(cell_list, title, x_size, y_size, gap_x, font_name, font_size)
...
set(1, 'Units','points', 'BackingStore','off', ...
    'Color', [0.8 0.8 0.8], 'MenuBar','none', ...
	'Resize','off', 'Name', title, ...
