...
%
% It is assumed that the two cameras (left and right) have been calibrated with the pattern at the same 3D locations,
% and the same points on the pattern (select the same grid points). 
% Therefore, in particular, the same number of images were used to calibrate both cameras.
